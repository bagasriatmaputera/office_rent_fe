                ...
                <div className="flex flex-col w-full rounded-[20px] border border-[#E0DEF7] p-[30px] gap-[30px] bg-white">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex flex-col gap-[6px]">
                            <div className="flex items-center gap-1">
                                <img
                                    src="/public/images/icons/Star 1.svg"
                                    className="w-5 h-5"
                                    alt="star"
                                />
                                <img
                                ...
                                />
                                <img
                                    src="/public/images/icons/Star 5.svg"
                                    className="w-5 h-5"
                                    alt="star"
                                />
                            </div>
                    ...
                    <div className="grid grid-cols-3 gap-x-5 gap-y-[30px]">
                        <div className="flex items-center gap-4">
                            <img
                                src="/public/images/icons/security-user.svg"
                        ...
                        <div className="flex items-center gap-4">
                            <img
                                src="/public/images/icons/cup.svg"
                                className="w-[34px] h-[34px]"
                                alt="icon"
                            />
                            <div className="flex flex-col gap-[2px]">
                        ...
                        <div className="flex items-center gap-4">
                            <img
                                src="/public/images/icons/home-trend-up.svg"
                                className="w-[34px] h-[34px]"
                                alt="icon"
                            />
                            <div className="flex flex-col gap-[2px]">
                        ...
                        <div className="flex items-center gap-4">
                            <img
                                src="/public/images/icons/3dcube.svg"
                                className="w-[34px] h-[34px]"
                                alt="icon"
                            />
                            <div className="flex flex-col gap-[2px]">
                        ...
                        <div className="flex flex-col gap-[30px]">
                            <div className="flex items-center justify-between gap-3">
                                <div className="flex items-center gap-4">
                                    <div className="w-[60px] h-[60px] rounded-full overflow-hidden">
                                        <img
                                            src="/public/images/photos/photo-1.png"
                                            className="w-full h-full object-cover"
                                            alt="photo"
                                        />
                                    </div>
                                ...
                                <div className="flex items-center gap-3">
                                    <a href="#">
                                        <img
                                            src="/public/images/icons/call-green.svg"
                                            className="w-10 h-10"
                                            alt="icon"
                                        />
                                    </a>
                                    <a href="#">
                                        <img
                                            src="/public/images/icons/chat-green.svg"
                                            className="w-10 h-10"
                                            alt="icon"
                                        />
                                    </a>
                            ...
                            <div className="flex items-center justify-between gap-3">
                                <div className="flex items-center gap-4">
                                    <div className="w-[60px] h-[60px] rounded-full overflow-hidden">
                                        <img
                                            src="/public/images/photos/photo-2.png"
                                            className="w-full h-full object-cover"
                                            alt="photo"
                                        />
                                    </div>
